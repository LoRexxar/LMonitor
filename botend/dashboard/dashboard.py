...
MODEL_DESCRIPTIONS = {
    ...
    'WowTodaySnapshot': '今日魔兽原始快照',
    'WowTodaySectionSetting': '今日魔兽板块配置',
    'WowTodayCardSnapshot': '今日魔兽卡片快照',
    'WowTodayCardSetting': '今日魔兽卡片配置',
...
COMMON_FIELD_LABELS = {
    ...
    'game_version': '游戏版本',
    'expansion_id': '资料片 ID',
    'expansion_name': '资料片名称',
    'translation_missing': '未翻译数量',
    'raw_json': '原始数据',
    'sections_json': '板块数据',
    'section_key': '板块标识',
    'section_name': '板块名称',
...
class DashboardView(View):
    ...
    SIMC_DEDICATED_API_MODELS = {
        ...
        'WowItemSnapshot', 'WowTodaySnapshot', 'WowTodayCardSnapshot',
        'PortalMplusSeasonCutoff', 'PortalMythicstatsDpsRow',
