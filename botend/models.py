...
class WowArticle(models.Model):
    ...
    nga_board_id = models.CharField(max_length=32, blank=True, default='', db_index=True)
    nga_board_name = models.CharField(max_length=255, blank=True, default='')
    nga_replies_updated_at = models.DateTimeField(null=True, blank=True)
