...
@file: hexagram.py
@time: 2024/03/19
@desc: Hexagram Interface Implementation
'''
...
class HexagramInterface:
    ...
    def get_hexagram(self):
        ...
        message = random.choice(hexalist)
    ...
    def get_hexagram_mess(self, content_type=0):
        """
        随机获取一个卦象
        :return:
        """
        ...
        # 检查是不是星期4，如果不是则返回
        if current_date.weekday() != 3 and content_type == 2:
