        ...
        openModal({
            ...
            content: `
                <div class="mdt-help">
                    ...
                    <div><strong>数据来源：</strong>副本地图、怪物、刷新点、编队、进度、技能 ID、特性和 POI 直接转换自 <a href="https://github.com/Nnoggie/MythicDungeonTools/tree/6.2.0-alpha3" target="_blank" rel="noopener noreferrer">MythicDungeonTools 6.2.0-alpha3</a>，按 GPLv2 保留来源。</div>
