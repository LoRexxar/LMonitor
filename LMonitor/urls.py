...
urlpatterns = [
    ...
    path('api/simc-task/preview/', csrf_exempt(SimcTaskPreviewAPIView.as_view()), name="simc_task_preview"),
    ...
    path('api/simc-battlenet-preflight/', csrf_exempt(SimcBattlenetPreflightAPIView.as_view()), name="simc_battlenet_preflight"),
